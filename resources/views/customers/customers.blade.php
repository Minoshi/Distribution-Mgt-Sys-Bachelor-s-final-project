                    ...
                    <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <input class="form-control border-0" type="search"
                                            placeholder="Search Customer By Name" aria-label="Search">
                                    </div>
                                    <button type="submit"
                        ...
                        <div class="col-lg-2">
                            <button type="submit" class="pull-right btn btn-primary btn-sm waves-effect waves-light"
                                data-toggle="modal" data-target="#addCustomerModal"><b><i class="ion-plus-round"></i>
                                Customer</b>
                            </button>
                        </div>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-secondary btn-sm waves-effect"
                                        data-toggle="modal" data-target="#editCustomerModal" title="Update">
                                        <i class="typcn typcn-edit"></i></button>

                                    <button type="button" class="btn btn-warning btn-sm waves-effect"
                                        data-toggle="modal" data-target="#editCustomerPswdModal"
...
@include('customers/change_password')
