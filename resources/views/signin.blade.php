...
<div class="wrapper-page">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="p-3">
                <h4 class="text-muted font-18 m-b-5 text-center">Welcome to DMS!</h4>
                <p class="text-muted text-center">Sign in to continue to Distribution Management System</p>
                ...
                <form class="form-horizontal m-t-30" action="{{ route('loginMy') }}" method="POST">
                    ...
                    <div class="form-group m-t-10 mb-0 row">
                        ...
                        <p>Don't have an account ? <a href="pages-register"
    ...
    <div class="m-t-40 text-center">
        ...
        <!-- <p> © 2017  - <?php echo date('Y') ?>abc  target="_blank"> annn</a>  in  <img  style="padding-bottom: 3px;min-height: 15px;" src="{{ URL::asset('assets/images/resources/flag.png') }}"/></p> -->
